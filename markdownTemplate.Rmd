...
#for loop goes through every column of the data set
  for (y in 1:ncol(confirmedData)+6) {
    #checks if it is TRUE that instane in column 5 is greater than 0
    ...
    #sets the index of the most recent date
...
paste(confirmedData[recentCountry,1], "is", distanceInMiles, "away from", confirmedData[largestIndex,1], ",", confirmedData[largestIndex,2])
```
...
#print(confirmedCasesSansCruise)
```
